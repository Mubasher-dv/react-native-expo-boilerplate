---
name: init-app
description: Scaffold a new Expo project using @codingpixel/create-expo-app with full prompt control + PM choice. Slash-command flow is non-TTY — all answers are resolved BEFORE invoking the CLI.
---
